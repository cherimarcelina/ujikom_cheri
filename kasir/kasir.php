...
//   exit;
// }
// if ($_SESSION['akun_level'] = 4) { header("location:../index.php");}
$order = mysqli_query($koneksi,"SELECT * from user inner join orderd WHERE status_order = 'belum dibayar' AND orderd.id_user=user.id_user order by orderd.id_order desc");
...
<div class="container"> 
  <div class="content cf">
        <h1 style="color:firebrick; font-size: 25px; ">Kasir<img src="../img/cheri.png" width="30px" style="margin-right:10px; margin-left: 20px;">
</h1>
