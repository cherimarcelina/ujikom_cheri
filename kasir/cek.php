...
<a href="transaksi.php?id=<?= $row_order["id_order"]; ?>"style="margin-left: 94%;  background-color: maroon; border-radius: 3px; padding: 7px; text-decoration: none; color: white; width:10%;">Bayar</a>
